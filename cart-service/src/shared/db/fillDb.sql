...
insert into orders (id, cart_id, user_id, comments, total, payment, delivery, status)
    values ('ef38910f-232a-42e0-9595-7664ec984f86', '0a0690ed-e763-4c57-bc56-7e59698c68e4', '00580619-2a67-4070-8f02-7e1994ee9fa1', 'some_comment_5', 999, '{"type": "card"}', '{"type": "delivery_5", "address": "some_address_5"}', 'PROCESSING');
